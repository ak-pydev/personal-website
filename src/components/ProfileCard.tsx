      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="absolute left-1/2 bottom-[-45px] will-change-transform transition-transform duration-[120ms] ease-out min-w-full min-h-full object-cover object-center"
                src={avatarUrl}
